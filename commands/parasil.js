...
module.exports = {
  name: "parasil",
  description: "Belirli bir kullanıcının bakiyesinden para siler",
  type: 1,
  options: [
    {
      name: "kullanıcı",
      description: "Para silmek istediğiniz kullanıcıyı etiketleyin",
      type: 6,
      required: true,
    },
    {
      name: "miktar",
      description: "Silinecek para miktarını belirtin",
      type: 4,
      required: true,
    },
  ],
  run: async (client, interaction) => {
    ...
    const embed = new EmbedBuilder()
      .setColor("#b8860b")
      .setDescription(`:white_check_mark: ${kullanıcı} kullanıcısının bakiyesinden **${miktar} €** silindi.\n\nYeni Bakiye: **${bakiye2} €**`);
